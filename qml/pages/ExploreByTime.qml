    ...
    SilicaListView {
        ...
        delegate: BackgroundItem {
            ...
            onClicked: {
                ...
                console.log("item by time : " + selectedItem)
                ...
                pageStack.push(Qt.resolvedUrl("Talks.qml"), {
                                   ...
                                   timeId : selectedItem.internalId
                               });
            }
        ...
        Component.onCompleted: {
            ...
            var sbModelItem = manager.getStartTimesForEventDayAsSelectBoxModelItems(selectedDate);
            sbModelItem.forEach(function(element) {
                timeListModel.append(element);
            });
        }
